                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-overview" id="other-information">
                                ...
                                <form action="../process/users/delete-account.php" method="POST" id="deleteAccountForm">

                                    <input type="hidden" name="delete-account" value="1">

                                    <div class="text-center">
                                        <button class="btn btn-danger float-end" onclick="return confirmDelete()">
                                            Delete Account
                                        </button>
                                    </div>
                                ...
                                <script>
                                    function confirmDelete() {
                                        return confirm("Are you sure you want to delete your account? This shit cannot be undone.");
                                    }
                                </script>
