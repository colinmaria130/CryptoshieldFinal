    ...
    <section class="section">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body mt-3">
                ...
                <div class="row gx-4 gy-4">
                    ...
                    $get_folders->execute([":is_archive" => "No"]);
                                ...
                                <div class="card shadow-lg border-0 rounded-4 text-center p-3 folder-card h-100 position-relative" style="transition: 0.3s; cursor: pointer;">
                                    ...
                                    <div class="dropdown position-absolute top-0 end-0 m-2">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="folderMenuBtn">
                                            <li>
                                                <a class="dropdown-item" href="home.php?page=folder-contents&folder-id=<?php echo htmlspecialchars(base64_encode($folder_data["folder_id"])); ?>">
                                            ...
                                            <li>
                                                <form action="../process/admin/file-management.php" method="POST" id="archive-folder-form">
                            ...
                            <div class="modal fade" id="update-folder-<?php echo htmlspecialchars($folder_data["folder_id"]); ?>" tabindex="-1" aria-labelledby="updateFolderModal" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content border-0 shadow-lg rounded-4">
                                        ...
                                        <form action="../process/admin/file-management.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check form-switch mb-2">
                                                        <input class="form-check-input"
                                                            type="checkbox"
                                                            id="brgyCaptainAccess-<?php echo htmlspecialchars($folder_data["folder_id"]); ?>"
                                                            value="Yes"
                                                            name="brgy-captain-access"
                                                            <?php echo $folder_data["brgy_captain_access"] === "Yes" ? "checked" : ""; ?>>
                                                        <label class="form-check-label" for="brgyCaptainAccess-<?php echo htmlspecialchars($folder_data["folder_id"]); ?>">
                                                            Brgy. Captain Access
                                                        </label>
                                                    </div>
                    ...
                    <tr class="text-center border-bottom">
                      ...
                      <td>
                        <div class="d-flex justify-content-center gap-1">
                          ...
                          <form action="../process/admin/file-management.php" method="POST" id="archive-file-form">
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-content border-0 shadow-lg rounded-4">
                          ...
                          <div class="modal-header border-0 bg-secondary text-white rounded-top-4">
                            ...
                            <h5 class="modal-title fw-bold text-wrap" style="white-space: normal; word-break: break-word;" id="updateFilePermission">
                          ...
                          <form action="../process/admin/file-management.php" method="POST">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="mb-3">
                                ...
                                <div class="form-check form-switch mb-2">
                                  <input class="form-check-input" type="checkbox" id="brgyCaptainDownload"
                                    value="Yes" name="allow-brgy-captain-download"
                                    <?php echo $file_data["brgy_captain_download"] === "Yes" ? "checked" : ""; ?>>
                                  <label class="form-check-label" for="brgyCaptainDownload">
                                    Brgy. Captain
                                  </label>
                                </div>
                          ...
                          <form action="../process/admin/file-management.php" method="POST">
                            ...
                            <div class="modal-body">
                              ...
                              <select class="form-select form-select-md mb-3" aria-label=".form-select-lg example" name="folder-id" required>
                                ...
                                <?php
                                    $fetch_admin_folders = $conn->prepare("SELECT * FROM admin_folder_tbl WHERE is_archive = 'No' ORDER BY folder_name ASC");
                                    $fetch_admin_folders->execute();

                                    while($folder = $fetch_admin_folders->fetch()) {
                                        ?>
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-header bg-dark text-white fw-bold fs-3 d-flex justify-content-between">
            ...
            Officials Files with no Folders
              ...
              <table class="table align-middle table-hover shadow-sm rounded datatable">
                ...
                <tbody class="bg-white">
                  ...
                  $get_folder_files = $conn->prepare("
                        SELECT 
                          ofl.*,
                          CONCAT(oa.first_name, ' ', oa.last_name) AS 'uploader_name'
                        FROM officials_files_tbl ofl
                        LEFT JOIN officials_accounts_tbl oa
                        ON ofl.uploaded_by = oa.official_id
                        WHERE ofl.is_archive = :is_archive AND ofl.folder_id IS NULL
                        ORDER BY uploaded_at DESC
                    ");
                  $get_folder_files->execute([":is_archive" => "No"]);
                  ...
                  while ($file_data = $get_folder_files->fetch()) { ?>
                    <tr class="text-center border-bottom fw-bold ">
                      ...
                      <td>
                       ...
                       <td>
                        <?php echo htmlspecialchars($file_data["uploader_name"]); ?>
                      </td>
            ...
            <form action="../process/admin/file-management.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="brgy-captain-access" value="Yes" name="brgy-captain-access" checked>
                            <label class="form-check-label" for="brgy-captain-access">
                                Brgy. Captain
                            </label>
                        </div>
