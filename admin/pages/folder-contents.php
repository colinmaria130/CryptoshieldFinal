<?php
  ...
  $get_folder_contents = $conn->prepare("SELECT * FROM admin_folder_tbl WHERE is_archive = :is_archive AND folder_id = :folder_id LIMIT 1");
      ...
      <div class="col-12">
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-header bg-dark text-white fw-bold fs-3 d-flex justify-content-between">
            Folder: <?php echo htmlspecialchars($folder_data->folder_name); ?>
...
<div class="modal fade" id="upload-file" tabindex="-1" aria-labelledby="addFolderModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content border-0 shadow-lg rounded-4">
      ...
      <form action="../process/admin/file-management.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-switch mb-2">
              <input class="form-check-input" type="checkbox" id="brgyCaptainDownload"
                value="Yes" name="allow-brgy-captain-download" checked>
              <label class="form-check-label" for="brgyCaptainDownload">
                Brgy. Captain
              </label>
            </div>
