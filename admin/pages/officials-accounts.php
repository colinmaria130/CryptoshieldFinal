            ...
            <table class="table table-light table-hover datatable table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th scope="col" class="fixed-column text-center"> Last Login </th>
              ...
              <tbody>
                ...
                $fetch_officials_data = $conn->prepare("SELECT 
                                                                          ...
                                                                          ORDER BY 
                                                                          FIELD(oa.position, 'Brgy. Captain', 'S.K. Chairman', 'Brgy. Secretary', 'Brgy. Treasurer', 'Brgy. Kagawad', 'S.K. Kagawad')");
                ...
                ?>
                  <tr class="text-center">
                    ...
                    <td class="fw-bold">
                      <?php echo htmlspecialchars(format_timestamp($official_data["last_login"]) ?? "N/A"); ?>
                    </td>
