        ...
        <div class="card shadow-sm mb-4">
          ...
          <div class="card-body pb-0">
            ...
            <table class="table table-light table-hover datatable table-responsive">
              ...
              <thead>
                <tr>
                  <th scope="col" class="text-center fixed-column"> File Name </th>
              ...
              <tbody>
                <?php
                    $fetch_uploads_logs = $conn->prepare("SELECT
                                                        ...
                                                        WHERE ofs.uploaded_by = :official_id AND (ofs.is_archive = :is_archive OR ofs.folder_id IS NULL)
                                                        ORDER BY ofs.uploaded_at DESC
                                                        ");

                    $fetch_uploads_logs->execute([":official_id" => $official_id, ":is_archive" => "No"]);
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <div class="d-flex justify-content-center align-items-center gap-1 ">
                                ...
                                <a href="home.php?page=my-folder-contents&folder-id=<?php echo htmlspecialchars(base64_encode($log_data["folder_id"])); ?>"
